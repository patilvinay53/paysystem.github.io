...
//$sql = "select * from user where username='".$username."' and password = '".$password."' or 1=1";
							  ...
							  <h3 class="myhead">Online Fees Payment System</h3>
                                <form role="form" action="login.php" method="post">
									...
									<div class="form-group input-group">
                                            ...
                                            <input type="int" class="form-control"  placeholder="Your Password" name="password" required />
                                        </div>
